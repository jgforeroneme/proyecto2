	...
	<div class="card card card-container">
		<h2 class="titlelogin">Registrar Usuario</h2>
        	<form class="form-signin" id="Registrar" name="Registrar" method="POST">
                    ...
                    <input type="password" name="password" id="password" class="form-control" placeholder="Contraseña" value="<?php echo $value["usuClave"]?>">
                    <input type="text" name="perfil" id="perfil" class="form-control" placeholder="Perfil" value="<?php echo $value["usuPerfil"]?>">
                    <input type="text" name="id" id="id" class="form-control"  value="<?php echo $value["id"]?>">
